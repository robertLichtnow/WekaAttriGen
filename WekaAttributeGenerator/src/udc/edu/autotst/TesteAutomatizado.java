...
public class TesteAutomatizado {
	...
	public static void main(String[] args) throws Exception {
		TesteAutomatizado.testeAutomatizadoCarSplitTaxa(10, 20.0);
	}

	
	public static void testeAutomatizadoCarSplitTaxa(int seed, double initialPercent) throws Exception {
		String pathArff = "C:\\Users\\mathlich\\Desktop\\datasets\\car\\car.data.arff";
		...
		PrintWriter pw = new PrintWriter(new File("C:\\Users\\mathlich\\Desktop\\resultados\\Resultados-Car-" + unique + ".csv"));
